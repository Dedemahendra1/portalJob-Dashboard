...
import TitleForm from '../organize/TitleForm'
...
import CustomUpload from '../organize/CustomUpload';
...
import InputSkills from '../organize/InputSkills';
import CKEditor from '../organize/CKEditor';
        ...
        <Separator className='mb-7' />
         ...
         <Form {...form} >
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-7'>
            ...
            <FieldInput
              title="Company Logo"
              subtitle="This image will be shown on the public as company logo"
            >
